...
import lowFrictionWrapper from 'text!common/views/experiments/participation/low-friction-wrapper.html';
import lowFrictionContents from 'text!common/views/experiments/participation/low-friction-contents.html';
import lowFrictionButtons from 'text!common/views/experiments/participation/low-friction-buttons.html';
...
function getUserVote() {
    ...
    const currentPage = config.page.pageId;
    const votedPages = JSON.parse(storage.local.get(prefs));
