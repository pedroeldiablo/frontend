...
import adblockStickyMessage from 'text!common/views/commercial/adblock-sticky-message.html';
import adblockStickyMessageCoin from 'text!common/views/commercial/adblock-sticky-message-coin.html';
