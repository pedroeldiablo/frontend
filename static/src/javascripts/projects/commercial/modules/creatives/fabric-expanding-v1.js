...
FabricExpandingV1.prototype.buildVideo = function(customClass) {
    ...
    var videoHeight = detect.isBreakpoint({
        max: 'phablet'
    }) ? 125 : 250;
    var videoWidth = videoHeight * videoAspectRatio;
    var leftMargin = this.params.videoPositionH === 'center' ? 'margin-left: ' + videoWidth / -2 + 'px' : '';
    var leftPosition = this.params.videoPositionH === 'left' ? 'left: ' + this.params.videoHorizSpace + 'px' : '';
    var rightPosition = this.params.videoPositionH === 'right' ? 'right: ' + this.params.videoHorizSpace + 'px' : '';
...
FabricExpandingV1.prototype.stopVideo = function(delay) {
    ...
    var videoSelector = detect.isBreakpoint({
        min: 'tablet'
...
FabricExpandingV1.prototype.create = function() {
    ...
    var $fabricExpandingV1 = $.create(template(fabricExpandingV1Html, {
