...
import identity from 'lodash/utilities/identity';
import gimbapSimpleStr from 'text!commercial/views/creatives/gimbap/gimbap-simple-blob.html';
import gimbapRichmediaStr from 'text!commercial/views/creatives/gimbap/gimbap-richmedia-blob.html';
import manualCardStr from 'text!commercial/views/creatives/manual-card.html';
import manualCardLargeStr from 'text!commercial/views/creatives/manual-card-large.html';
import manualCardCtaStr from 'text!commercial/views/creatives/manual-card-cta.html';
import manualContainerButtonStr from 'text!commercial/views/creatives/manual-container-button.html';
...
function preprocessGimbap(tpl) {
    ...
    tpl.params.hasAuthorImage = tpl.params.offer1authorimage && tpl.params.offer1authorimage.length > 0 && tpl.params.layout !== '1x1x1x1';
}
